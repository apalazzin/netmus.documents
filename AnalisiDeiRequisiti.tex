...
\hline\\
\multicolumn{3}{p{470px}}{ Inserimento degli use case, diagramma e testo,
UC3.}\\
\\
...
\subsubsection*{Aggiornamento informazioni}
\bo{Id:} C2FD-2 \\
\bo{Tipo:} funzionale \\
\bo{Richiesta:} desiderabile \\
\bo{Fonte:} verbale1 \\
...
\begin{tabular}{|l|l|l|}
\rowcolor{Orange}
\bo{C2: recupero delle informazioni} \\
\hline
\cellcolor{orange}
...
\cline{2-2}
 & Recupero manuale & \\
\cline{2-3}
 & Informazioni senza connessione & Ottimizzazione memoria cache\\
\cline{2-3}
 & Informazioni dall'hard disk & \\
\cline{2-3}
 & File ignorati & Indicazioni file ignorati \\
\hline
\cellcolor{orange}
