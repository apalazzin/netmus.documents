...
\chapter*{Sommario}
Nel presente documento viene descritto il prodotto specificandone
funzionalit\`a e contesti d'uso, vengono analizzati vari casi d'uso tramite
diagrammi UML e viene pubblicata la lista dei requisiti emersi durante la
fase di analisi.
