...
descritti alcuni use-case che comprendono la quasi totalit\`a dei requisiti
elaborati.
...
vogliono indicare sia le funzionalit\`a attese nel prodotto finale sia gli
...
installazione e uso}
Il prodotto finale utilizzer\`a diverse tecnologie (in particolare: Java, GAE e
...
\begin{enumerate}
  ...
  dettagli tra cui c'\`e anche il player di YouTube che permette di ascoltare la
...
\begin{enumerate}
  ...
  versioni \`e la pi\`u completa e adotta una strategia di ``merge'' che minimizzi
  la ridondanza.
