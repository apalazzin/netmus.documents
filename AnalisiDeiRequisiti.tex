...
\thispagestyle{fancy}
(C1/C2)(F/Q/I/V)(N/D/O)-n1.n2.n3...nn
C1 = componente 1 (Componente di persistenza e visualizzazione)
C2 = componente 2 (Componente di recupero delle informazioni dei brani musicali
contunuti nei sistemi di riproduzione personale dell'utente) F = funzionale
Q = qualità
I = interfacciamento
V = vincolo
...
C1FN-1.9.1-Controllo di validità dei dati
...
C1QN-1.6-Scalabilità (capitolato)

C1QN-1.6.1-Scalabilità interfaccia grafica

C1QN-1.6.2-Scalabilità massa di utenza

C1QN-1.11-Deve utilizzare il cloud computing

C1QN-3-Utilizzo

C1QN-3.1-Accessibilità

C1QN-3.3-Portabilità

C1QD-3.4-Supporto multi-lingua

C1QN-3.5-Semplicità di utilizzo

C1QN-3.6-Manutenibilità
...
\begin{itemize}
  \item Dovrebbe raccogliere i dati anche se non è disponibile una connessione.
  ...
  \item Potrebbe essere tradotto in più lingue (preferibilmente italiano e
  inglese).
