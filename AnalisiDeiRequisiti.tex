...
\bo{Richiesta:} obbligatorio \\
\bo{Fonte:} capitolato \\
Tutte le informazioni inviate dalla componente 2 saranno controllate in maniera
...
\bo{Invio nuove informazioni a componente 2} \\
\bo{Id:} C1FD-1.10 \\
\bo{Tipo:} funzionale \\
\bo{Richiesta:} desiderabile \\
\bo{Fonte:} verbale1 \\
...
alla componente 2 per andare ad aggiornare i file multimediali dell'utente.
\\
\\
...
musicale dopo essersi registrato ed aver messo in funzione la componente 2.
\\
\\
