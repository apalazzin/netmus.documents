...
\newcommand{\datamodifica}{15 Dicembre 2010}
...
d'appalto 02 \underline{NetMus}. Per favorire la comprensione dell'analisi proposta sono
descritti alcuni diagramma use-case che rispettano lo standard \underline{UML}
2.2 e comprendono la quasi totalit\`a dei requisiti elaborati.
...
informazioni aggiuntive procurate da NetMus in formato \underline{pdf} predisposto per la stampa.
\\
\\
