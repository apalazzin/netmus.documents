...
\newcommand{\datamodifica}{23 Gennaio 2011}
...
\begin{itemize}
  ...
  \item la visualizzazione ed l'utilizzo avverranno tramite browser,
  sar\`a necessaria la connessione ad Internet;
...
una \underline{JVM} che non sia ad una versione obsoleta. Sarà
...
\bo{Attori primari:} Utente \\\\
\bo{Pre-condizioni:} Tutte le componenti del sistema sono attive e l'utente,
connesso ad internet, vi accede. \\\\ 
\bo{Post-condizioni:} Se online sono state inviate al server tutte le
...
\begin{enumerate}
  ...
  interessa e ne visualizza ed amministra i dettagli (UC1.3.3, UC1.3.3.1, UC1.3.3.2, UC1.3.3.3)
