...
\section{UC1 - Sistema NetMus (1/2)}
...
\vspace*{0.5cm}
\bo{Use case UC1: Sistema NetMus (1/2)}\\\\
\bo{Attori primari: } Utente \\\\
\bo{Pre-condizioni: } L'utente è connesso ad internet ed accede al portale
...
\section{UC2 - Sistema NetMus (2/2)}
...
\vspace*{0.5cm}
\bo{Use case UC2: Sistema NetMus (2/2)}\\\\
\bo{Attori primari: } Utente \\\\
\bo{Pre-condizioni: } L'utente è connesso ad internet ed accede al portale
NetMus tramite un browser. \\\\ 
...
periferiche dell'utente. I tag dei file musicali dell'utente sono stati
