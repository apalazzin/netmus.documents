...
brani presente nel vostro catalogo, che sar\`a impostato a zero. Questo \`e il men\`u
...
\\
All'estrema sinistra della pagina \`e presenta la barra per la scansione
dei \underline{dispositivi di archiviazione di massa}, chiamata pi\`u
semplicemente ``DEVICE SCANNER BAR''. Tale barra \`e visibile nella sua
completezza solo al passaggio sopra di essa del mouse. La barra permette la
scansione manuale e la visualizzare l'avanzamento dell'analisi ed estrazione
automatica o manuale dei file mp3 da un dispositivo o una \underline{directory}
selezionata.\\ \includegraphics[width=15cm]{img/MU/applet_bar_open.png}\\
...
player YouTube in basso.\\ \includegraphics[width=15cm]{img/MU/player_youtube.png}\\
...
molto comoda per poter avere una sequenza delle canzoni preferite.\\
...
\underline{form} apposta. La form, visualizzata nella pagina in alto a destra,
