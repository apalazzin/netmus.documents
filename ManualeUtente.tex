...
\hline
\endfoot
25/02/2011 & 0.2 & Baron Federico & Stesa parte preliminare delle istruzioni per
l'uso.\\
\hline
...
cliccando il tasto ``Scan Folder'' per la scannerizzazione manuale, e
selezionando la directory.\\
\begin{figure}[htbp]
  \centering
  \includegraphics[width=15cm]{img/MU/scan_manual.png}\\ 
\caption{Interfaccia di selezione di una directory per la scannerizzazione
manuale}
\end{figure}
...
\begin{itemize}
  ...
  ricerca di tale canzone produce risulati errati. Modificare le informazioni
