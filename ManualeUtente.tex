...
Qui di seguito presentiamo i documenti tecnici di riferimento che il gruppo a
creato durante lo sviluppo del software. Tali documenti torneranno utili per
quegli utenti esperti che vogliano conoscere l'architettura di sviluppo del sistema
\co{NetMus}:
\begin{itemize}
...
gratuiti.\\
Per accedere alle form di registrazione basta cliccare alla voce ``Sign up in to
Netmus'' e la view cambier\`a mostrandovi i campi per la registrazione.
...
Come prima funzionalit\`a inseriamo la descrizione dell'operazione pi\`u
interessante del nostro prodotto, ossia la riproduzione delle tracce in streaming.\\ Per
