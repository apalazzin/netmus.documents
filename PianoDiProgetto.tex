...
\hline
\endfoot
30/01/2011 & 1.6 & Lovato Daniele & Completato consuntivo.\\
\hline
...
Come si può notare dalla tabella, la progettazione architetturale ad alto
livello ha occupato più ore di quante se ne fosse preventivato.
...
A compensare le ore in più svolte in progettazione è l'attività di correzione
dei documenti dopo gli esiti della RR, che ha occupato quasi 20 ore in meno del
previsto. Per quanto riguarda le rimanenti attività, le ore preventivate e le
ore parziali combaciano quasi perfettamente ad esclusione
dell'aggiornamento del PQ che ha richiesto una decina di ore in più rispetto a
quelle preventivate.\\
\\
\\
...
Come illustra chiaramente il grafico, per ogni membro il monte ore parziale per
questa fase si aggira intorno alle 35 ore, proprio come preventivato, che è
circa il 25\% delle ore totali.\\
\\
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=17.2cm, angle=0]{img/PP/BUDGET-RP.png}
\caption{Stato del budget utilizzato fino a RP}
\end{figure}
\vspace{0.5cm}

Il budget speso è stato all'incirca il 26.6\% del budget totale.\\
\\
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=17.2cm, angle=0]{img/PP/COSTI-RP.png}
...
lavoro.\\
La Probabilità di occorrenza di questo rischio è direttamente proporzionale alla
