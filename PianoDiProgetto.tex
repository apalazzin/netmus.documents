...
Specifica Tecnica che sar\`a il nostro documento in ingresso alla RP. Verr\`a poi dedicato un p\`o di tempo nel cominciare la Progettazione di Dettaglio, in modo da impostare bene il lavoro che partir\`a a pieno regime appena dopo tale revisione.\\ Parteciperanno qualche ora alla progettazione iniziale anche due Analisti, per individuare vincoli ed eventuali rischi tecnologici.\\
\\
...
Verr\`a inoltre fatt\`a internamente la validazione del sistema per verificare
...
della fase RR-RP e le ore effettivamente utilizzate dagli sviluppatori.
