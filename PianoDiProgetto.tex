...
Fortunatamente non \`e stato cos\`i, la codifica \`e ripartita subito dopo
la correzione, e nelle ore precedenti ci si \`e dedicati per la maggior parte
alla documentazione.\\
...
rispettato maggiormente rispetto alle fasi passate. Sono state spese 9 ore
...
anche se la notevole attivit\`a di progettazione ha fatto sforare un po' il 
...
l'attivit\`a di verifica sia stata la pi\`u dispendiosa in termini di tempo, in
termini di costi la pi\`u dispendiosa \`e stata sicuramente quella di
progettista, influenzata anche dall'ampio lavoro di progettazione svolto dal gruppo.
