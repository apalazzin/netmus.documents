...
la gestione e creazione di ticket cos\`i come descritto nel documento Norme di
Progetto;
...
giudicato troppo dispendioso in termini di tempo o risorse si dovrà comunicare
al cliente l'anomalia stessa, la sua origine e l'intenzione di non trattarla.

\section{Trattamento delle discrepanze}

Una discrepanza può essere rilevata in sede di validazione; compito della
comunicazione e della individuazione spetta ai verificatori. Per notificare
discrepanze dovrà essere usato lo strumento issue-tracker messo a disposizione
nella pagina \url{http://code.google.com/p/netmus}. Per ogni discrepanza
...
studio vengono solitamente sviluppati i modelli di processo che descrivono il
processo stesso.
...
Qualora la qualità del processo risulti minore di quella preventivata,
...
di rivelare eventuali difettii. Sarà applicata durante la verifica della fase
realizzativa.
...
in modo strutturale (white-box) o funzionale (black-box) su ciascuna unità; divverà completo quando avrà provato tutte le unità definite entro le
