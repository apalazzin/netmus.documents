...
l'intero cicolo di vita del pogetto, a partire dalla stesura dell'intera
documentazione fino alle ultime fasi di collaudo del sofware prima della
...
Al fine di garantire un'elevata qualit\`a del prodotto finale l'impegno che ci
si assume \`e quello di pianificare ed effettuare una costante attivit\`a di
verifica e validazione in tutte le fasi del progetto. Ogni singola modifica o
