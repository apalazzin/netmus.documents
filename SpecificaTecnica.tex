...
\end{figure}
Questi patterns vengono introdotti all'interno della
componente model di MVP e riguardano gli oggetti utilizzati per l'incapsulamento dei dati nelle
...
\begin{itemize}
  ...
  \item requisiti intrisecamente legati alla piattaforma.
\end{itemize}
%non tracciati
\begin{footnotesize}
\centering
