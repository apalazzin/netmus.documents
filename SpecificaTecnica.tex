...
{\color{Removed_Grey}Il sistema mette a disposizione una vista per la modifica
...
In seguito alla progettazione di dettaglio si \`e scelto di non utilizzare
pi\`u questa classe. il suo ruolo verr\`a rivestito da \co{ProfileView}.\\\\
{\color{Removed_Grey}Il sistema mette a disposizione una vista per
visualizzazione e la modifica del catalogo brani utente. La classe \co{EditSongsViewImpl} implementa l'interfaccia
...
\subsubsection*{Tipo, obiettivo e funzione del componente}
Questa classe estende \co{AbstractActivity}, implementa il \co{Presenter}
interno alla \co{EditSongsView} e richiede al \co{clientFactory} di
implementarela.
