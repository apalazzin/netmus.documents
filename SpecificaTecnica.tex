...
precedentemente descritti. Abbiamo deciso però di non utilizzarlo, progettando
...
pattern Singleton}
\end{figure}
Singleton è un design pattern creazionale che ha lo scopo di assicurare
...
occuperà di creare degli speciali oggetti introdotti da JDO per la comunicazione
