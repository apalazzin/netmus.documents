...
client.ClientFactoryImpl & \\
client.mvp.NetmusActivityMapper & \\
client.mvp.NetmusPlaceHistoryMapper & \\
client.activity.LoginActivity & \\
client.activity.ProfileActivity & \\
client.activity.EditUserActivity & \\
client.activity.EditSongsActivity & \\
client.service.LoginService & \\
client.service.UsersService & \\
client.service.SongsService & \\
client.service.LibraryService & \\
client.place.LoginPlace & \\
client.place.ProfilePlace & \\
client.place.EditUserPlace & \\
client.place.EditSongsPlace & \\
client.ui.LoginView & \\
client.ui.ProfileView & \\
client.ui.EditUserView & \\
client.ui.EditSongsView & \\
shared.GenericDTO & \\
shared.SongSummaryDTO & \\
shared.SongDTO & \\
shared.LoginDTO & \\
shared.MusicLibraryDTO & \\
shared.UserSummaryDTO & \\
shared.UserDTO & \\
shared.UserCompleteDTO & \\
shared.NetMusException & \\
shared.LoginException & \\
shared.WrongLoginException & \\
shared.RegistrationException & \\
shared.NickNotFreeException & \\
shared.DuplicateEmailException & \\
server.PMF & \\
server.LoginHelper & \\
server.SongsServiceImpl & \\
server.LoginServiceImpl & \\
server.UserServiceImpl & \\
server.LibraryServiceImpl & \\
server.utils.AuthenticationProvider & \\
server.utils.Utils & \\
server.utils.ServletUtils & \\
server.servlet.LoginSuperServlet & \\
server.servlet.LoginGoogleServlet & \\
server.servlet.LoginGoogleCallbackServlet & \\
server.servlet.YouTubeServlet & \\
server.persistent.UserAccount & \\
server.persistent.MusicLibrary & \\
server.persistent.Song & \\
\hline
