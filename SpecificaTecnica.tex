...
\hline
30/01/2011 & 0.17 & Baron Federico & Integazione con nuovi contenuti del
...
facilitarne la comprensione si utilizzaranno diagrammi aderenti allo
...
l'architatura mascroscopica del sistema per poi scendere pi\`u nel dettaglio
...
individuate durante la progettazione \`e il sueguente: 
\begin{figure}[h]
  \centering
...
\newpage
\subsubsection{Decomposizione architeturale - diagrammi delle attivit\`a}
Nella realizzazione di un'applicazione Web l'efficenza e la
qualit\`a della visualizzazione dei contenuti assumono grande importanza per cui
buona parte della strattura di NetMus lavorer\`a al fine di garantire queste
componenti. \\
...
login.\\ 
Una volta richiesta la pagina avverranno in sequeza le seguenti attivit\`a:
\begin{itemize}
...
\begin{itemize}
  ...
  autenticazione NetMus e facendo una rischiesta esterna tramite
...
corrispondenze con eventuali brani gi\`a presenti nel nosto DataStore: se un
...
ad-hoc tenuto da Miriade S.P.A. presso le sedi dell'Univerist\`a di Padova,
