...
30/01/2011 & 0.12 & Baron Federico & Inserite componenti del package
server.persistent.\\
\hline
...
\subsection{Classe LibraryService}
\subsubsection*{Tipo, obiettivo e funzione del componente}
\subsubsection*{Relazioni d'uso di altre componenti}
\subsubsection*{Interfacce con e relazioni d'uso da altre componenti}
\subsubsection*{Attivit\`a svolte e dati trattati}
...
scopo di interfacciare il sistema con il database nascondendo così ogni
...
\subsection*{Tipo, obiettivo e funzione del componente}
Questo package contiene tutti i nostri ServletHttp che ci permetteranno di
comunicare con servizi esterni, quale Google Authentication, YouTube o eventualmente altri
servizi per avere informazioni complete sui brani musicali.
...
\subsection*{Interfacce con e relazioni d'uso da altre componenti}
Queste classi verranno pubblicate come servizi HTTP, e saranno accessibili da
URL una volta assegnato loro un indirizzo in WAR/web.xml.

\subsection*{Attivit\`a svolte e dati trattati}
Vedere nel dettaglio i vari Servlet.
...
\subsubsection*{Tipo, obiettivo e funzione del componente}
Questa servlet avr\`a lo scopo di reindirizzare l'utente all'
