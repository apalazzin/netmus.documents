...
\newcommand{\nomefile}{ManualeUtente-ENG-\versione.pdf}
...
\hline
\endfoot
19/03/2011 & 1.0 & Trezzi Giovanni & Document validated.\\
\hline
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=14cm]{img/MU/issues.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=14cm]{img/MU/new_issue.png}
...
Go to the link \url{http://netmusproject.appspot.com} to start using
\co{NetMus}.\\ \begin{figure}[!htbp]
  \centering
