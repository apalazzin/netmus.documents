...
software development. Those documents will be useful for that expert users that
 will better understand the architecture of \co{NetMus}:
\begin{itemize}
...
Google, you can join \co{NetMus} using your Google account.
...
If you aren't a Google user and this is your first access to \co{NetMus}, you can
