...
Per l'identazione si devono utilizzare 4 spazi e non il TAB perch\'e
...
$\Rightarrow$ inserire un nuovo nome in ``Profile Name'', inserire 4 in ``Tab
Size'' e selezionare ``Use spaces to indent wrapped lines''. \\
Evitare le linee più lunghe di 80 caratteri, dal momento che non sono gestite
bene da molti terminali e strumenti.\\ \\
