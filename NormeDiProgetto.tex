...
31/01/2011 & 1.6 & Palazzin Alberto & Aggiunta sezione 6.2 ``Tracciamento dei
requisiti - componenti''.\\
\hline
30/01/2011 & 1.5 & Palazzin Alberto & Correzione errori grammaticali e
semantici in tutto il documento.\\
\hline
22/01/2011 & 1.4 & Palazzin Alberto & Sistemati capitoli 3, 5 e 10.\\
\hline
...
gestione delle risorse pianificata nel \emph{PianoDiQualifica-2.0.pdf}.
\\ \\
Il \underline{ticketing} sar\`a utilizzato tramite gli appositi strumenti
forniti da Google Code al link \url{http://code.google.com/p/netmus/issues/list}.
Al link \url{http://code.google.com/p/support/wiki/IssueTracker} si pu\`o
trovare un tutorial che spiega come usare questo strumento.\\
...
maggiori dettagli vedi documento \emph{PianoDiQualifica-2.0.pdf}).
...
\begin{itemize}
  ...
  \item \bo{Cclmv1} = la classe NetMusetc del package client.mvp
\end{itemize}
