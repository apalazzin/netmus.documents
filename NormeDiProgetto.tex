...
\newcommand{\versioneNP}{4.0}
\newcommand{\versioneGL}{4.0}
\newcommand{\versionePP}{4.0}
\newcommand{\versionePQ}{5.0}
\newcommand{\versioneAR}{3.0}
\newcommand{\versioneST}{3.0}
\newcommand{\versioneDP}{2.0}
...
\subsection{Tracciamento dei requisiti - componenti di progettazione ad alto
