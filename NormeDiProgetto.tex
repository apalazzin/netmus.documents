...
usare l'identazione con il TAB (poco portabile) ma utilizzare gli spazi (4); per
quest'ultimo caso si pu\`o continuare ad usare il TAB andando per\`o ad
...
$\Rightarrow$ inserire un nuovo nome in ``Profile Name'', inserire 4 in ``Tab Size'' e selezionare ``Use spaces to indent wrapped lines''.
\\\
