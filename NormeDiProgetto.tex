...
estratti dall'analisi fatta dai VT.G, gli verrà assegnato un codice. 
La lista dei requisiti sarà presente solamente nel documento
\emph{AnalisiDeiRequisiti-n.0.pdf} mentre in tutti gli
...
musicali contunuti nei sistemi di riproduzione personale dell'utente)\\
F =funzionale\\
Q = qualità\\
I = interfacciamento\\
V = vincolo\\
