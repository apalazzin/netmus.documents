...
manutenzione, che quasi nessun software è mantenuto per tutta la sua vita
dall'autore originale e che queste convenzioni migliorano la leggibilità
del software consentendo ai progettisti di comprendere il nuovo codice più
...
Un file è costituito da sezioni che dovrebbero essere separate da linee vuote e
un commento opzionale che identifica ogni sezione. I file più di 2000 linee sono
...
è possibile inserirle nello stesso file della classe pubblica.
\\ \\
...
size''. \\ Evitare le linee più lunghe di 80 caratteri, dal momento che non sono gestite bene da molti terminali e strumenti.\\ \\
...
\begin{itemize}
  ...
  di fuori dell'espressione tra parentesi, che è ad un livello superiore);
