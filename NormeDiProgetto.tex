...
\begin{itemize}
  ...
  indentificare i loro requisiti;
...
descrivere opure decomponibile a sua volta.
...
cercando una soluzione archichetturale del prodotto che impieghi dei componenti
...
produce una descrizione dela struttura interna e dell'organizzazione del sistema
...
delle classi, degli oggetti, di attivit\`a e di sequenza. \\ \\
...
precise metriche (coesione, accomppiamento, utilit\`a, dipendenza,
complessit\`a).

\subsubsection{Tracciamento dei requisiti - componenti}
