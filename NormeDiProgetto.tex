...
\newcommand{\versionenormeprogetto}{0.9}
...
\hline\\
\multicolumn{3}{p{470px}}{ Controllo e correzione degli errori ortografici.}\\
\\
...
\bo{Autore:} Palazzin Alberto\\
\hline\\
\multicolumn{3}{p{470px}}{ Sistemazione dei Capitoli 4, 9 e 10.}\\
\\
...
\item {la sede principale del gruppo;}
...
\item {RPS: Revisione di Progettazione con Specifica Tecnica; }
\item {RPD: Revisione di Progettazione con Defizione del Prodotto;}
...
\item {Per Windows: proTeXt (versione 2010). 
\\
Scarica e installa dal link
...
previsione della RR: da 0.19 a 1.0).
...
dei requisiti sar\`a presente solamente nel documento
