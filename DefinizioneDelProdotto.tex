...
\endlastfoot
 ...
 - is\_google\_user: boolean & Flag che indica se l'utente accede a
 Netmus tramite un'account Google oppure no.\\\hline
 - ispublic\_profile: boolean & Flag che indica se il profilo
 dell'utente \`e visibile ad altri utenti oppure no.\\\hline 
...
+ getters() & Restituiscono i campi dati privati della classe.\\\hline
+ setters() & Modificano i campi dati privati della classe.\\\hline
+ retrieveHttpLocation() & Restituisce l'URL di un certo YouTubeMedia.\\\hline
...
\endfoot
\endlastfoot
- retrieveVideo(in String, in String, in int) \emph{static} & Metodo
interno che effettua la ricerca video dati in ingresso un clientID, una
String contenente le keywords ed il tempo di timeout.\\\hline
- convertVideos(in List\textless VideoEntry\textgreater) \emph{static} &
Converte la lista di video trovati nel nostro formato interno
...
noi.\\\hline
+ getSearchResult(in String) \emph{static} & Metodo statico usabile
