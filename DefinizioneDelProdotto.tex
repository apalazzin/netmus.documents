...
\hline
\endfoot
17/03/2011 & 1.14 & Caputo Cosimo & Inserimento delle classi legate
...
a questa entità come la ricerca di particolari utenti all'interno del Datastore.
\begin{longtable}{|p{0.4\textwidth}|p{0.4\textwidth}|}
\hline
\rowcolor{orange} \bo{Attributo} & \bo{Descrizione} \\
\hline
...
\endlastfoot
 ...
 l'oggetto \co{Song} in cui id è dato in input.\\\hline
