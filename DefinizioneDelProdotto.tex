...
23/02/2011 & 0.15 & Caputo Cosimo & Agginti diagrammi delle classi per il
...
elencate le componenti con l'assegnamento dei nuovi codici
identificativi.\\
Le modfiche apportate sono dovute principalmente al maggior dettaglio
...
l'adattamento alle nuove scelte archietturali introdotte nel paragrafo
precedente. Infine la struttura dell'applet di estrazione dei brani \`e definita
in qeusto documento per la prima volta.\\
Per ulteriori chiarimenti sulle scelte progettuali operate si rimanda
alla descrizione specifica delle componenti presentata nel
capitolo 3.
\begin{footnotesize}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=15cm]{img/DP/classes_server_utils.png}
\caption{Diagramma UML delle classi che descrive le dipendenze
fondamentali presenti all'interno del package
