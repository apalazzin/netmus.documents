...
\co{Presenter} e saranno utilizzate all'interno dei metodi handler. \\
I contratti dei metodi (che vengono implementati in \co{LoginActivity}) in
questione sono: 
\begin{itemize}
...
\# LoginType NETMUSLOGIN, NETMUSREGISTRATION: enum & Possibili tipologie di
login e registrazione.\\\hline
\end{longtable}
\begin{longtable}{|p{0.4\textwidth}|p{0.4\textwidth}|}
\hline
