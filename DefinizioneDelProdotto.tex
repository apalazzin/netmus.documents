...
implementato in \co{LibraryServiceImpl}.
...
\subsubsection*{Relazioni d'uso di altre componenti} Vengono usate le classi della libreria twig-persist2.0 per la creazione di \co{AnnotationObjectDatastore}.
\subsubsection*{Interfacce con e relazioni d'uso da altre componenti}
...
\subsection*{Relazioni d'uso di altre componenti}
Tutte le classi in \emph{shared.exception} sono sottotipi della classe
\co{Exception} del package \emph{java.lang}.
\subsection*{Interfacce con e relazioni d'uso da altre componenti}
...
metodo \co{start()}, da parte della \underline{JVM} quando caricata nella pagina
Web. I suoi metodi pubblici \co{letsGo} e \co{setState} possono essere invocati
tramite JSNI da GWT.
