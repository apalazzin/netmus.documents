...
\hline
\endfoot
17/03/2011 & 1.10 & Caputo Cosimo & Inserimento delle classi legate
all'esportazione pdf.\\
\hline
15/03/2011 & 1.10 & Baron Federico & Inserimento della classe Album nel
capitolo 4.\\
\hline
14/03/2011 & 1.9 & Baron Federico & Rimozione di tutti i paragrafi
riguardanti le relazioni con altre componenti poich\'e gi\`a presente in ST.\\
\hline
14/03/2011 & 1.8 & Baron Federico & Rimozione delle tabelle 4.1 e 4.2 come
suggerito nella correzione di RQ.\\
\hline
13/03/2011 & 1.7 & Caputo Cosimo & Inserimento della specifica riguardante la
classe PDFLoaderServlet.\\
\hline
12/03/2011 & 1.6 & Caputo Cosimo & Inserimento della specifica riguardante il
package velocity e le relative classi.\\
\hline
12/03/2011 & 1.5 & Caputo Cosimo & Inserimento della specifica riguardante la
classe GdataManager.\\
\hline
12/03/2011 & 1.4 & Caputo Cosimo & Aggiornamento di tabella 3.1 a fronte di
...
\begin{itemize}
  ...
  \item \bo{Esportazione PDF} : Questa funzione \`e implementata usando il
...
\bo{+} & server.servlet.PDFLoaderServlet & Csese5 \\\hline 
...
estratti, viene elaborata 30 brani alla volta creando liste di SongDTO.
...
reperire informazioni aggiuntive dai servizi esterni YouTube e Last.fm quali link per copertine e video in streaming.
\subsubsection*{Attivit\`a svolte e dati
...
\subsection{Classe PDFLoaderServlet}
\subsubsection*{Requisiti obbligatori soddisfatti}
\begin{itemize}
  \item 
\end{itemize}
...
\endfoot
\endlastfoot
\caption{Campi dati di PDFLoaderServlet}
\end{longtable}
\begin{longtable}{|p{0.4\textwidth}|p{0.4\textwidth}|}
\hline
\rowcolor{orange} \bo{Metodo} & \bo{Descrizione} \\
...
\endfoot
\endlastfoot
\caption{Metodi di PDFLoaderServlet}
\end{longtable}
...
\end{itemize}
\subsubsection*{Tipo, obiettivo e funzione del componente}
La classe estende il supertipo astratto \co{ResourceLoader} e fornisce i metodi
che permettono di caricare il template (``mio\_template''.mv) dal file system.
La classe appartiene al framework \emph{Velocity}.
\subsubsection*{Attivit\`a svolte e dati trattati}
I metodi di \co{VelocityResourceLoader} svolgono le funzioni di caricare una
