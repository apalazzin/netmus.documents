...
sistema. Verranno suddivise le componenti in maniera da distinguere quelle
definite durante la progettazione di dettaglio 1 e quelle da integrare durante
la progettazione di dettaglio 2. Dopo ogni processo di progettazione di
dettaglio verr\`a effettuata la relativa codifica, delle quali verr\`a
allegato il codice sorgente.
...
\section{Codici assegnati a nuove componenti}
