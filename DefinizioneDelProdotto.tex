...
23/02/2011 & 0.14 & Caputo Cosimo & Agginti diagrammi delle classi per il
package server e i relativi sotto-package.\\
\hline
18/02/2011 & 0.13 & Baron Federico & Aggiornamento finale del capitolo 3 in
...
\bo{--} & client.activity.EditUserActivity  &  Cclac3 \\\hline
\bo{--} & client.activity.EditSongsActivity  &  Cclac4 \\\hline 
...
\bo{--} & client.place.EditUserPlace  &  Cclpl3 \\\hline 
\bo{--} & client.place.EditSongsPlace  &  Cclpl4 \\\hline 
& client.ui  &  Cclui0 \\\hline 
& client.ui.LoginView  &  Cclui1 \\\hline 
& client.ui.ProfileView  &  Cclui2 \\\hline 
\bo{--} & client.ui.EditUserView  &  Cclui3 \\\hline 
\bo{--} & client.ui.EditSongsView  &  Cclui4 \\\hline 
\bo{+} & client.ui.MyConstants  &  Cclui5 \\\hline  
& client.applet  &  Cclap0  \\\hline 
\bo{+} & AppletBar (??) &  \\\hline 
\bo{+} & AppletConstants  &  Cclap1 \\\hline 
\bo{+} & TranslateDTOXML  &  Cclap2  \\\hline 
& shared  &  Csh0 \\\hline 
\bo{--} & shared.GenericDTO  &  Csh1 \\\hline 
& shared.SongSummaryDTO  &  Csh2 \\\hline 
& shared.SongDTO  &  Csh3 \\\hline 
& shared.LoginDTO  &  Csh4 \\\hline 
& shared.MusicLibraryDTO  &  Csh5 \\\hline 
\bo{--} & shared.UserSummaryDTO  &  Csh6 \\\hline 
...
\bo{--} & shared.exception.WrongLoginException  &  Cshex3 \\\hline 
& shared.exception.RegistrationException  &  Cshex4 \\\hline 
\bo{--} & shared.exception.NickNotFreeException  &  Cshex5 \\\hline 
\bo{--} & shared.exception.DuplicateEmailException  &  Cshex6 \\\hline 
& server  &  Cse0 \\\hline 
\bo{--} & server.PMF  &  Cse1 \\\hline 
...
\bo{--} & server.utils.AuthenticationProvider  &  Cseut1 \\\hline 
...
\bo{--} & server.servlet.YouTubeServlet  &  Csese4 \\\hline 
...
\endfoot
\endlastfoot
- APPLET\_BAR: AppletBar \emph{static} & \\\hline
- visible: boolean & \\\hline
- constants: AppletConstants & \\\hline
- title: Label & \\\hline
- on\_off: Anchor & \\\hline
- rescan: Anchor & \\\hline
- status: TextBox & \\\hline
- applet: HTML & \\\hline
- user: String & \\\hline
- original\_user: String & \\\hline
- state: boolean & \\\hline
- translator: TranslateDTOXML & \\\hline
- library\_service: LibraryServiceAsync  & \\\hline
...
\endfoot
\endlastfoot
+ get(in String, in boolean): AppletBar \emph{static} & \\\hline
+ appletBarON() & \\\hline
+ appletBarOFF() & \\\hline
+ changeState() & \\\hline
+ reScanAll() & \\\hline
+ sendStarts() & \\\hline
+ sendStartsJSNI(in String, in boolean) \emph{native} & \\\hline
+ scanningStatus(in int, in int) & \\\hline
+ showStatus(in String) & \\\hline
+ translateXML(in String) & \\\hline
+ makeNativeFunction(in AppletBar) \emph{native} & \\\hline
...
\subsection{Classe DeviceScannedEventHandler}
\subsubsection*{Requisiti obbligatori soddisfatti}
\begin{itemize}
    \item 
\end{itemize}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=15cm]{img/DP/classes_server_persistent.jpg}
\caption{Diagramma UML delle classi che descrive le dipendenze
fondamentali presenti all'interno del package
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=15cm]{img/DP/classes_servlet.png}
\caption{Diagramma UML delle classi che descrive le dipendenze
fondamentali presenti all'interno del package
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=15cm]{img/DP/classes_utils.png}
\caption{Diagramma UML delle classi che descrive le dipendenze
fondamentali presenti all'interno del package
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=15cm]{img/DP/classes_shared_exception.png}
\caption{Diagramma UML delle classi che descrive le dipendenze
fondamentali presenti all'interno del package
