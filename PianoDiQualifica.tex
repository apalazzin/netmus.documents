...
Calcolare il numero di collaborazioni di ogni classe, ovvero con quante classi
...
Inoltre calcolare la coesione di ogni metodo, propriet\`a di un metodo di
...
\textbf{Dati in input}: verrà creata una stringa xml con una notevole quantità
di brani e rispettive informazioni. \\
\textbf{Output Attesi}: Il metodo dovrà ritornare una lista di DTO di tutti i
...
\textbf{Output Attesi}: tipo di ritorno void, ma ciò che si aspetta è che l'account
...
richieste di 41 requisiti funzionali. Il rapporto tra i 2 \`e
considerato soddisfacente. \\\\ Viene registrato un sovraccarico delle funzionalit\`a richieste al modulo
