...
\subsubsection{Correttezza dello stile}
...
Utilizzare lo strumento FindBugs per ricercare eventuali errori o bug comuni non
scovati in precedenza. Ulteriori informazioni sullo strumento sono riportate
nella sezione 2.3.\\\\
Esito atteso: ci si aspetta di avere codice pi\`u stabile risolvendo
eventuali errori trovati.\\\\ 
Tecniche: AFC, AFD, ----------.

\subsubsection{Controllare le metriche e gli indicatori sul codice}
...
potrebbero essere particolarmenti complicati, o scritti in modo confuso.\\\\ 
Esito atteso: i valori misurati sia nei package sia nei metodi delle
classi, dovrebbe essere nella norma.\\\\ 
Tecniche:.

\subsubsection{Verifica Dinamica tramite Test di Unit\`a}
...
canzone memorizzandolo sul DB della relativa canzone e di pasarlo alla view per
visualizzarlo\\
...
viene aggiunta perch\`e gi\`a presente, in caso negativo viene regitrata e i
campi corretti relativi alle infomazioni della libreria vengono aggiornati\\
