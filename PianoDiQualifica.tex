...
C1FD-1.3, C1FO-1.3.3, C1FO-1.3.4, C1FD-1.4.4, C1FD-1.5,
...
\bo{B} &
\bo{C1FN-1.2, C1FO-1.2.1, C1FD-1.3.1,
...
\begin{itemize}
  \item Requisito C1FO-1.2.1 : Pagina di Login\\
  ...
  \item Requisito C1FD-1.3.1, C1FD-1.3.2 : Modifica informazioni brano,
  Cancellazione brano\\
...
\begin{itemize}
  ...
  \item il lucchetto della device scan difficile da schiacciare.
\end{itemize}
