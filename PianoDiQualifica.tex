...
accedere in maniera esclusiva ad attributi della classe. Se ogni attributo è acceduto da
...
\textbf{Aspettative}: Il metodo dovrà ritornare una lista di DTO di tutti i
...
\textbf{Aspettativer}: Una view ben formattata con la rimozione del brano
effettuata\\
...
\textbf{Aspettative}: l'account dell'utente deve venire eliminato dal DB così
...
\begin{itemize}
  ...
  \item TU-Cse3: SongServiceImpl\\
  \textbf{metodo}: rateSong\\
  \textbf{esito del test}: la valutazione del brano ricervuta in input viene
  ...
  \item TU-Csepe5: UserAccount\\
  \textbf{metodo}: findSessionUser\\
  \textbf{esito del test}: viene caricato e resituito l'utente corretto
