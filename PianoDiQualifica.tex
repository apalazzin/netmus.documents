...
analisi v.1.7 indicati come modificati a fornte della precedente verifica sulla
versione 1.6.\\
\hline
30/01/2011 & 1.13 & Lovato Daniele & Sistemata Sezione 3.1 e 3.2.
Perfezionata sezione 5.1.\\
\hline
30/01/2011 & 1.12 & Palazzin Alberto & Correzione errori ortografici. Sistemazione dei termini enfatizzati. Aggiunto strumento ASPELL. Correzione
semantica. Correzzione della punteggiatura su elenchi puntati.
...
Aggiunti i link per reperire gli strumenti. Aggunto paragrafo 4.4 ``Dettaglio
...
l'esito della verifica sulla qualità dei requisiti. Paragrafo 4.2.1. Aggiunto
...
il paragrafo 2.7.1. ``Metodi di verifica per la documentazione'', aggiunta la tabella ``Correzione documenti'' in Appendice. Aggiunto paragrafo 2.7.2 ``Metodi di verifica per l'analisi" e le tabelle B e C in appendice per la verifica dei requisiti.\\
\hline
...
del capitolo 2, rinominato il capitolo 4 in ``Resoconto delle attività di
...
Un'anomalia è una deviazione da una norma o da una struttura standard
considerata normale. Possiamo prevedere che la maggioranza delle anomalie verrà 
...
Una discrepanza è un discostamento, totale o parziale, dalle attese del
...
Verifica dei requisiti proposti come corretti nel documento
...
Durante la fase di collaudo, si attuerà un procedimento per individuare carenze
relative alla correttezza, alla completezza e all'affidabilità delle componenti 
software create rispetto ai requisiti definiti durante la fase di analisi.\\
Il collaudo consisterà in due fasi: 

\begin{itemize}
  \item collaudo interno(alpha test), in cui viene effettuato prima del rilascio
  ...
  di qualità elevata e avere bisogno di ulteriori correzioni. 
  Il compito di questi soggetti esterni e di valutarne la fruibilità e l'accessibilità.
\end{itemize}
