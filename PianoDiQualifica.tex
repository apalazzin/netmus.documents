...
\section{Organizzazione, pianificazione\\strategica e temporale,
responsabilit\`a}
...
\\
\\ 
Al fine di procedere in modo rigoroso per quanto riguarda la misurazione
delle varie parti del progetto, verrà applicato quanto affermato all'interno
della ISO 15939 dove la misurazione del software è un processo iterativo PDCA,
con 4 attività principali.
\\
\\
\includegraphics[height=4cm]{img/pdca.png}
\\
\\
Le esigenze di misurazione verranno definite nel presente capitolo dove per ogni
fase progettuale verranno indicate le necessità che ci si prefigge
di soddisfare e le risorse necessarie e dispobili ai fini del processo di
qualifica. Verranno inoltre indicati quali strumenti saranno utilizzati.
Nel capitolo numero 3 verranno approfondite le procedure e le metriche
relativmamente alla pianificazione della misurazione mentre nel capitolo numero
4 verranno trattate le tecniche da utilizzare. Una volta volta terminata
l'attività di verifica e la conseguente attività di misurazione, si procederà
con il riportare l'esito in appendice al presente documento. A questo punto
sulla base dei risultati si decideranno eventuali manovre correttive o
l'accettazione del prodotto verificato secondo le misure stabilite. 


\subsection{Feedback di valutazione}
Per aiutare il responsabile a comprendere quali fattori posso influenzare
positivametne o negativamente le varie fasi del progetto è stato introdotto un
sistema di raccolta feedback su tutte le attività svolte. Ogni volta che
qualcuno porta a termine un'attività dovrà compilare un brevissimo questionario
...
per ciascuno di queste voci verrà data una valutazione da 1 a 10 in base alla
propria soddisfazione. Alla fine di ogni fase di progetto verrà sviluppato un
grafico con la media dei punteggi il quale confrontato con i risultati ottenuti
potrà fornire ulteriori ed interessanti spunti su come correggere o
rafforzare il modo di procedere nel lavoro.
...
\item correttezza rispetto a quanto stabilito nel documento
...
Per quanto riguarda la definizione dei requisiti software in fase progettuale
verrà adottato il modello FURPS, elaborato inizialmente da RoberGrady presso i
laboratori dell'Hewlwtt-Packard.
FURPS è un acronimo mnemonico per la definizione dei requisiti di software di
vario genere e sta a significare:
...
\subsection{Strumenti per la verifica della documentazione}
DA COMPLETARE CON I VARI STRUMENTI X LA CORREZIONE DI (VEDI 2.1.1)

\subsection{Strumenti per la verifica della progettazione}
DA COMPLETARE PARLANDO DI COME COSTRUIRE UNA TABELLA CON I QUALI VERIFICARE
(2.1.2) RELATIVAMENTE AI REQUISITI TROVATI

\subsection{Strumenti per la realizzazione/programmazione}
DA COMPLETARE

\subsection{Strumenti per la progettazione}
DA COMPLETARE\\\\

(Da rimuovere, sistemare e distribuire la seguente lista)
\begin{itemize}
...
\subsection{Misure nelle specifiche}

\begin{itemize}
  
\item numero di entità in un diagramma E/R;
\item numero di blocchi in un Diagramma DFD;
\item numero degli use case points;
...
\subsection{Tecnice d'analisi per la documentazione}
DA COMPLETARE

\subsection{Tecnice d'analisi per l'analisi}
DA COMPLETARE (AD ESEMPIO COME SI USA LA TABELLA paragrafo 2.3.2)

\subsection{Tecnice d'analisi per le specifiche}
DA COMPLETARE

\subsection{Tecnice d'analisi per la progettazione}
DA COMPLETARE

\subsection{Tecnice d'analisi sul codice}
DA RIVEDERE\\
