...
\section{Dettaglio dell'esito sul test di valutazione sul processo di lavoro}
I risultati del feedback fatto su ogni ticket di questa fase di progettazione
sono stati raffigurati da 4 grafici riportati di seguito.

\begin{figure}[h]
  \centering
  \includegraphics[height=7cm]{GraficiFeedbackTicket/LavoroSvolto.png}
\caption{Lavoro svolto.}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[height=7cm]{GraficiFeedbackTicket/IterazioneConGliAltri.png}
\caption{Iterazione con gli altri.}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[height=7cm]{GraficiFeedbackTicket/Strumenti.png}
\caption{Strumenti.}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[height=7cm]{GraficiFeedbackTicket/TempoImpiegato.png}
\caption{Tempo Impiegato.}
\end{figure}
