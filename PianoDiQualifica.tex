...
\begin{itemize}
  ...
  \item TI-cl1\\
  \textbf{esito del primo test}: fallito: i dettagli del brano spesso non sono
  corretti\\ 
  \textbf{malfunzionamenti rilevati}: c'\`e un'incongruenza tra l'ordine dei
  SongSummaryDTO e l'ordine con cui vengono messi nella view, che porta a
  richieste di dettagli di altri brani invece che di quelli realmente voluti\\
