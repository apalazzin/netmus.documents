...
notevole quantit\`a di brani.\\
\textbf{Aspettative}:  lista di String di playlist effettivamente memorizzate
nel DB dell'utente. \\
...
\textbf{Aspettative}: la lista di Stringhe degli amici per quando riguarda il
getter\\
...
\textbf{Aspettative}: tipo di ritorno vuoto, corretta visualizzazione sulla
...
\textbf{Aspettative}: Una lista di stringhe contenenti autore,titolo ed album\\
...
\textbf{Aspettative}: Una view ben formattata con la rimozione del brano
effettuata\\
