...
\subsubsection*{Test di Sistema}
Appena tutti i test di integrazione saranno completati si potr\`a procedere con
questo test. Il suo scopo \`e quello di verificare il comportamento
dinamico del sistema completo rispetto ai requisiti software e valutare le funzionalit\`a del
prodotto.
\\\\
