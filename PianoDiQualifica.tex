...
Quantificare il numero di functions points e sulla base di questi calcorae una
...
Per ogni verifica si dovrà aprire un ticket (per maggiori dettagli vedi
\emph{NormeDiProgetto-2.0.pdf}). Ogni verificatore dopo aver accettato la
commessa dovrà applicare dei metodi con delle tecniche
e delle metriche per persiguire degli obiettivi di verifica rispetto la fase su
cui sta lavorando (per maggiori dettagli vedi il capitolo 2). A fine lavoro
dovrà scrivere un resoconto valutanto i dati raccolti rispetto alle predizioni.
...
fase di revisione potrà fornire interessanti spunti su come correggere o rafforzare il metodo di lavoro.
