...
\hline\\
\multicolumn{3}{p{470px}}{ Validazione documento per consegna RR.}\\
\\
...
verifica e validazione in tutte le fasi del progetto. Ogni singola modifica o l'insieme di pi\`u modifiche comporteranno una conseguente attivit\`a di verifica. Al fine di
