...
\hline\\
\multicolumn{3}{p{470px}}{ Validazione
...
\hline\\
\multicolumn{3}{p{470px}}{ Correzione ortografica e sintattica. Commentate
lettere senza termini. Aggiunta del termine ``Propriet\`a emergenti''.
Ridisposizione dei termini in ordine alfabetico. }\\
&&\\
\end{tabular}
...
\hline\\
\multicolumn{3}{p{470px}}{ Aggiunti nuovi termini, apportate correzioni.}\\
&&\\
\end{tabular}
